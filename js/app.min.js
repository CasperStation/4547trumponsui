(() => {
    ...
    let r = (t, e = !1, o = 500, a = 0) => {
        ...
        if (s) {
            ...
            if (document.documentElement.classList.contains("menu-open") && n(), "undefined" != typeof SmoothScroll)(new SmoothScroll).animateScroll(s, "", l);
                ...
                t = r ? t - r : t, t = a ? t - a : t, window.scrollTo({
                    top: t,
                    behavior: "smooth"
                })
            }
    ...
    t.watcher = new class {
        ...
        scrollWatcherConstructor(t) {
            if (t.length) {
                this.scrollWatcherLogging(`Прокинувся, стежу за об'єктами (${t.length})...`), i(Array.from(t).map((function(t) {
    ...
    function m() {
        u = window.innerWidth < 1630 ? 15 : (window.innerWidth - 1600) / 2, d.length && d.forEach((t => {
    ...
    async function g() {
        try {
            const t = "Pj3sX83x2gsxwwfzhUuszdA8EWcJvkJ4g3k3LCfpump";
